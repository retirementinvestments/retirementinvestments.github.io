         ...
         '<div class="sgem-401k-form sgem-401k-cal-1">'+
            '<div class="sgem-401k-flex-container">'+
               '<div class="sgem-401k-form-group sgem-401k-form-flex sgem-401k-years-holder">'+
                  ...
                  '<span id="sgem_401k_err_my_age"></span>    '+
               '</div>'+
               '<div class="sgem-401k-form-group sgem-401k-form-flex sgem-401k-years-holder">'+
                  '<label>Retirement age</label>'+
                  '<input type="text" id="sgem_401k_retirement_age" value="67" min="0" max="150" onkeypress="return isNumber(event)"/> '+     
                  '<span id="sgem_401k_err_rmt"></span> '+
               '</div>'+
            '</div>'+
            '<div class="sgem-401k-flex-container">'+
               '<div class="sgem-401k-form-group sgem-401k-form-flex sgem-401k-currency-holder">'+
                  '<label>Income before taxes</label> '+
                  '<input type="text"class="inputmove inputnumber" id="sgem_401k_income_before_taxes" value="60000" min="0" max="100000" onkeypress="return isNumber(event)"/>'+
                  '<span id="sgem_401k_err_income_before_taxes"></span> '+
               '</div>'+
               '<div class="sgem-401k-form-group sgem-401k-form-flex sgem-401k-currency-holder">'+
                  ...
                  '<input type="text" class="inputmove inputnumber"  id="sgem_401k_current_balance" value="30000" min="0" max="50000000" onkeypress="return isNumber(event)"/>'+
                  '<span id="sgem_401k_err_current_balance"></span>   '+
               '</div>'+
            '</div>'+
               ...
               '<div class="collapsible-content">'+
                  '<div class="sgem-401k-flex-container">'+
                     '<div class="sgem-401k-form-group sgem-401k-form-flex sgem-401k-currency-holder">'+
                        ...
                        '<input type="text" id="sgem_401k_annual_contributions" class="inputnumber sgem_401k_full_width_field" value="1250" min="0" max="100000" onkeypress="return isNumber(event)"/>'+
                        '<span id="sgem_401k_err_annual_contributions"></span>   '+
                     '</div>'+
                  '</div>'+
                  '<div class="sgem-401k-flex-container">'+
                     '<div class="sgem-401k-form-group sgem-401k-form-flex">'+
                        ...
                        '<span id="sgem_401k_err_employer_match"></span>   '+
                     '</div>'+
                  '</div>'+
                  '<div class="sgem-401k-flex-container">'+
                     '<div class="sgem-401k-form-group sgem-401k-form-flex">'+
                        ...
                        '<input type="text" id="sgem_401k_limit_on_matching" class="inputnumber sgem_401k_full_width_field" value="2.0%" min="0" max="100" onkeypress="return isNumber(event)"/>'+
                        '<span id="sgem_401k_err_limit_on_matching"></span> '+
                     '</div>'+
                  '</div>'+
                  '<div class="sgem-401k-flex-container">'+
                     '<div class="sgem-401k-form-group sgem-401k-form-flex">'+
                        ...
                        '<input type="text" id="sgem_401k_rate_of_return" class="inputnumber sgem_401k_full_width_field" value="6.0%" min="0" max="100" onkeypress="return isNumber(event)"/>'+
                        '<span id="sgem_401k_err_rate_of_return"></span> '+
                     '</div>'+
                  '</div>'+
               '</div>'+
            '</details>'+
               ...
               '<div class="collapsible-content">'+
                  '<div class="sgem-401k-flex-container">'+
                     '<div class="sgem-401k-form-group sgem-401k-form-flex">'+
                        ...
                        '<input type="text" id="sgem_401k_annual_catchup_contribution" class="inputnumber sgem_401k_full_width_field" value="6.0%" min="0" max="100" onkeypress="return isNumber(event)"/>'+
                        '<span id="sgem_401k_err_annual_catchup_contribution"></span> '+
                     '</div>'+
                  '</div>'+
                  '<div class="sgem-401k-flex-container">'+
                     '<div class="sgem-401k-form-group sgem-401k-form-flex">'+
                        ...
                        '<input type="text" id="sgem_401k_growth_rate" class="inputnumber sgem_401k_full_width_field" value="2.0%" min="0" max="100" onkeypress="return isNumber(event)"/>'+
                        '<span id="sgem_401k_err_annual_catchup_contribution"></span> '+
                     '</div>'+
                  '</div>'+
               '</div>'+
            '</details>'+
            '<span class="sgem-401k-err-msg"></span>'+
         '</div>'+
      '</div>'+
         ...
         '<div class="sgem-401k-cal-1-result-wrapper">'+
            ...
            '<div class="sgem-401k-flex-container sgem-401k-column2">'+
               ...
               '<div class="sgem-401k-form-group sgem-401k-form-flex-section-two">'+
                  ...
                  '<div id="futureV2" class="sgem-401k-result-label-below">$<span id="sgem_you_will_need">12,458</span>'+
                  '</div>'+
               ...
               '<div class="sgem-401k-form-group sgem-401k-form-flex-section-three">'+
                  ...
                  '<div id="futureV3" class="sgem-401k-result-label-below">$<span id="sgem_you_will_need">24,258</span>'+
                  '</div>'+
            ...
            '<div class="sgem-401k-section-disclaimer">'+
               '<details class="sgem-401k-details-disclaimer">'+
                  '<summary>'+
                     ...
                     '</div>'+
                  '</summary>'+
                  '<div class="sgem-401k-collapsible-text-disclaimer">This material is provided for general and educational purposes only; it is not intended to provide legal, tax or investment advice.'+
                  '</div>'+
               '</details>'+
            '</div>'+
         '</div>'+
