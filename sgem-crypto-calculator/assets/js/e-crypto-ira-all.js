...
var sgem_crypto_main_content = '<div class="sgem-crypto-ira-cal-main-id"><div class="sgem-crypto-ira-cal-wrapper"><div class="sgem-crypto-ira-cal-left"><div class="sgem-crypto-ira-form sgem-crypto-ira-cal-1"><div class="sgem-crypto-ira-flex-container"><div class="sgem-crypto-ira-form-group sgem-crypto-ira-form-flex sgem-crypto-ira-years-holder"><label>My age is</label><input type="text" id="sgem_crypto_ira_age" value="35" min="0" max="150" onkeypress="return isNumber(event)"/><span id="sgem_crypto_ira_err_age"></span></div><div class="sgem-crypto-ira-form-group sgem-crypto-ira-form-flex sgem-crypto-ira-years-holder"><label>Retirement age</label><input type="text" id="sgem_crypto_ira_retirement_age" value="67" min="0" max="150" onkeypress="return isNumber(event)"/><span id="sgem_crypto_ira_err_retirement_age"></span></div></div><div class="sgem-crypto-ira-flex-container"><div class="sgem-crypto-ira-form-group sgem-crypto-ira-form-flex"><label>Annual Return <span class="sgem-crypto-info-tooltip tooltip" data-tippy-content="Return on non-crypto investments. Based on historic returns our estimate for average annual return is 6%. What is your expected earning on investment from now and retirement?">?</span></label><input type="text" class="inputmove inputnumber"  id="sgem_crypto_ira_annual_return" value="6%" min="0" max="100" onkeypress="return isNumber(event)"/><span id="sgem_crypto_ira_err_annual_return"></span></div><div class="sgem-crypto-ira-form-group sgem-crypto-ira-form-flex sgem-crypto-ira-currency-holder"><label>Annual contribution </label><input type="text" class="inputmove inputnumber"  id="sgem_crypto_ira_annual_contribution" value="6,000" min="0" max="100000" onkeypress="return isNumber(event)"/><span id="sgem_crypto_ira_err_annual_contribution"></span></div> </div><div class="sgem-crypto-ira-flex-container"><div class="sgem-crypto-ira-form-group sgem-crypto-ira-form-flex sgem-crypto-ira-currency-holder"><label>Current savings <span class="sgem-crypto-info-tooltip tooltip" data-tippy-content="Total savings in your IRA , 401(k), or other retirement account">?</span></label><input type="text"class="inputmove inputnumber" id="sgem_crypto_ira_current_savings" value="30,000" min="0" max="10000000" onkeypress="return isNumber(event)" /><span id="sgem_crypto_ira_err_current_savings"></span></div> </div><details class="sgem-crypto-ira-input-more-details" open><summary><div><h3 class="sgem-crypto-ira-collapsible-summary-title">Advanced</h3></div></summary><div class="collapsible-content"><div class="sgem-crypto-ira-flex-container"><div class="sgem-crypto-ira-form-group sgem-crypto-ira-form-flex sgem-crypto-ira-midtext">Percentage of current savings allocated for crypto</div></div>'+
'<span id="sgem_crypto_ira_err_current_total_allocation_zero"></span><div class="sgem-crypto-ira-flex-container"><div class="sgem-crypto-ira-form-group sgem-crypto-ira-form-flex sgem-crypto-ira-full-flex"><label>Total Allocation <span class="sgem-crypto-info-tooltip tooltip" data-tippy-content="Total percentage of portfolio allocated for Crypto">?</span></label><input type="text" class="sgem-crypto-ira-current-allocation"  id="sgem_crypto_ira_current_allocation" value="10%" min="0" max="100" onkeypress="return isNumber(event)"/><span id="sgem_crypto_ira_err_current_total_allocation"></span> </div></div><span id="sgem_crypto_ira_err_current_combine_total"></span><div class="sgem-crypto-ira-flex-container"><div class="sgem-crypto-ira-form-group sgem-crypto-ira-form-flex"><label>Bitcoin <span class="sgem-crypto-info-tooltip tooltip" data-tippy-content="Percentage of Bitcoin in crypto portfolio">?</span></label><input type="text" id="sgem_crypto_ira_bitcoin" class="inputnumber" value="56%" min="0" max="100" onkeypress="return isNumber(event)"/><span id="sgem_crypto_ira_err_current_bitcoin"></span></div><div class="sgem-crypto-ira-form-group sgem-crypto-ira-form-flex"><label>Ethereum <span class="sgem-crypto-info-tooltip tooltip" data-tippy-content="Percentage of Ethereum in crypto portfolio">?</span></label><input type="text" id="sgem_crypto_ira_ethereum" class="inputnumber" value="35%" min="0" max="50" onkeypress="return isNumber(event)"/><span id="sgem_crypto_ira_err_current_ethereum"></span> </div></div><div class="sgem-crypto-ira-flex-container"><div class="sgem-crypto-ira-form-group sgem-crypto-ira-form-flex sgem-crypto-ira-full-flex"><label>Other <span class="sgem-crypto-info-tooltip tooltip" data-tippy-content="Percentage of other crypto currencies in portfolio">?</span></label><input type="text" class="sgem-crypto-ira-other-crypto"  id="sgem_crypto_ira_other_crypto" value="9%" min="0" max="100" onkeypress="return isNumber(event)"/><span id="sgem_crypto_ira_err_current_other"></span></div></div><div class="sgem-crypto-ira-flex-container"><div class="sgem-crypto-ira-form-group sgem-crypto-ira-form-flex sgem-crypto-ira-midtext">Percentage of future contributions for crypto</div></div><span id="sgem_crypto_ira_err_future_total_allocation_zero"></span><div class="sgem-crypto-ira-flex-container"><div class="sgem-crypto-ira-form-group sgem-crypto-ira-form-flex sgem-crypto-ira-full-flex"><label>Total Allocation <span class="sgem-crypto-info-tooltip tooltip" data-tippy-content="Total percentage of portfolio allocated for Crypto in the future">?</span></label><input type="text" class="sgem-crypto-ira-future-allocation inputnumber"  id="sgem_crypto_ira_future_allocation" value="10%" min="0" max="100" onkeypress="return isNumber(event)"/><span id="sgem_crypto_ira_err_future_total_allocation"></span></div></div><span id="sgem_crypto_ira_err_future_combine_total"></span><div class="sgem-crypto-ira-flex-container"><div class="sgem-crypto-ira-form-group sgem-crypto-ira-form-flex"><label>Bitcoin <span class="sgem-crypto-info-tooltip tooltip" data-tippy-content="Percentage of Bitcoin in crypto portfolio">?</span></label><input type="text" id="sgem_crypto_ira_future_bitcoin" class="inputnumber" value="56%" min="0" max="100" onkeypress="return isNumber(event)"/><span id="sgem_crypto_ira_err_future_bitcoin"></span></div><div class="sgem-crypto-ira-form-group sgem-crypto-ira-form-flex"><label>Ethereum <span class="sgem-crypto-info-tooltip tooltip" data-tippy-content="Percentage of Ethereum in crypto portfolio">?</span></label><input type="text" id="sgem_crypto_ira_future_ethereum" class="inputnumber" value="35%" min="0" max="50" onkeypress="return isNumber(event)"/><span id="sgem_crypto_ira_err_future_ethereum"></span></div></div><div class="sgem-crypto-ira-flex-container"><div class="sgem-crypto-ira-form-group sgem-crypto-ira-form-flex sgem-crypto-ira-full-flex"><label>Other <span class="sgem-crypto-info-tooltip tooltip" data-tippy-content="Percentage of other crypto currencies in portfolio">?</span></label><input type="text" class="sgem-crypto-ira-other-crypto"  id="sgem_crypto_ira_future_other_crypto" value="9%" min="0" max="100" onkeypress="return isNumber(event)"/><span id="sgem_crypto_ira_err_future_current_other"></span></div></div></div></details><span class="sgem-crypto-ira-err-msg"></span></div></div><div class="sgem-crypto-ira-cal-right"><div class="sgem-crypto-ira-cal-1-result-wrapper"><div class="sgem-crypto-ira-cal-1-result-header"><div class="sgem-crypto-ira-value-label"><span class="sgem-crypto-ira-staticvalue-text">YOUR VALUE AT RETIREMENT </span><span id="sgem_crypto_ira_value_text" class="sgem-crypto-ira-value-text">$901,091.05</span></div><div class="sgem-crypto-ira-legendbox"><div class="sgem-crypto-ira-legend-item"><button id="sgem_crypto_ira_contribution" onClick="toggleData(0)" class="sgem-crypto-ira-contribution"></button><div id="sgem_crypto_ira_contribution_te" onClick="toggleData(0)" class="sgem-crypto-ira-contribution-te"></div></div><div class="sgem-crypto-ira-legend-item"><button id="sgem_crypto_ira_investment" onClick="toggleData(1)" class="sgem-crypto-ira-investment"></button><div id="sgem_crypto_ira_investment_te" onClick="toggleData(1)" class="sgem-crypto-ira-investment-te"></div></div></div></div><div class="sgem-crypto-ira-chartCard"><div class="chartBox"><canvas id="myChart"></canvas></div></div>';
...
sgem_crypto_main_content += '<div class="sgem-crypto-ira-section-disclaimer"><details class="sgem-crypto-ira-details-disclaimer"><summary><div class="sgem-crypto-ira-collapsible-summary-disclaimer">Disclaimer</div></summary><div class="sgem-crypto-ira-collapsible-text-disclaimer">This material is provided for general and educational purposes only; it is not intended to provide legal, tax or investment advice.</div></details></div>';
...
if( (location.hostname != "calculatorstg.wpengine.com") || (location.hostname != "retirementinvestments.com") || (location.hostname != "staging.retirementinvestments.com") ){
	sgem_crypto_main_content += '<div class="sgem-crypto-ira-logo-center"><a class="sgem-crypto-ira-url-text" href="https://retirementinvestments.com/crypto/crypto-ira-calculator/" target="_blank" rel="noopener">Crypto IRA Calculator&nbsp</a>by Retirement investments</div>';
}
...
function sgem_crypto_calculatermin() {
   ...
   //General Investments
    ...
    if (isNaN(crypto_value_at_retirement) || crypto_value_at_retirement < 1){
        ...
        $('#sgem_crypto_ira_value_text').text('$' + sgem_crypto_ConvertToInternationalCurrencySystem(crypto_value_at_retirement));
      }
      ...
      //interest
       ...
       var final_intrest_array = [];
           ...
           var ic_otherc = (ic_otherc3 + ic_otherc6).toFixed(2);
             ...
             crypto_intrest_chart.push(answer.toFixed(0));     
    
             }
            // alert('pcm_values_intrest');
             localStorage.setItem('crypto_values_intrest', JSON.stringify(crypto_intrest_chart));
             crypto_update_chart();
  }
...
localStorage.setItem('sgem-crypto-ira-cal-copy', '<div id="sgem-crypto-ira-cal"></div><script>window.onload = function() {var sgemciracl = document.createElement("script");sgemciracl.type = "text/javascript";sgemciracl.src = "https://retirementinvestments.github.io/sgem-crypto-calculator/assets/js/e-crypto-ira-min.js";document.body.appendChild(sgemciracl);} </script>'); 
 
function sgem_crypto_ira_copyText(ev){
  //console.log("hi");
  let div = document.getElementById('div');
  let text = localStorage.getItem('sgem-crypto-ira-cal-copy');
...
window.addEventListener('load', function() {	 
	let sgemjsxc = document.createElement('script');
	   sgemjsxc.setAttribute('src','https://retirementinvestments.github.io/sgem-crypto-calculator/assets/js/plugins/chartjs.min.js');
