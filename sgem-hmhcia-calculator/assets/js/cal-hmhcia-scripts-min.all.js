...
function sgemGenarateSlider(calby) {
    ...
    rangerOne.onchange = function() {
        sgemimgpig.width = width1 / (rangerOne.value / 20);
        sgemimgpig.height = height1 / (rangerOne.value / 20);

        sgemimghouse.width = width1 * (rangerOne.value / 20);
        sgemimghouse.height = height1 * (rangerOne.value / 20);
    }
}
