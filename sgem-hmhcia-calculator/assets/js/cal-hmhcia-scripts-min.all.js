...
function sgemGenarateSlider(calby) {
    ...
    rangerOne.onchange = function() {
        sgemimgpig.width = width1 / (rangerOne.value / 3 / 6);
        sgemimgpig.height = height1 / (rangerOne.value / 3 / 6);

        sgemimghouse.width = width1 * (rangerOne.value / 3 / 6);
        sgemimghouse.height = height1 * (rangerOne.value / 3 / 6);
    }
}
