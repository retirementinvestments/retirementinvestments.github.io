...
function sgemGenarateSlider(calby) {
    ...
    rangerOne.onchange = function() {
        sgemimgpig.width = width1 / (rangerOne.value / 30 );
        sgemimgpig.height = height1 / (rangerOne.value / 30 );
...
function sgemGenarateSlider2(calby) {
    ...
    ranger.onchange = function() {
        sgemimgpig.width = width / (ranger.value / 12000);
        sgemimgpig.height = height / (ranger.value / 12000);
