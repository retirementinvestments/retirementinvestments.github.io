...
if ($('#sgem_hmhcia_annual_income,#sgem_hmhcia_monthly_debts,#sgem_hmhcia_income_down_payment,#sgem_hmhcia_rent_payment,#sgem_hmhcia_loan_term,#sgem_hmhcia_home_insurance,#sgem_hmhcia_ahomeowners_association_dues,#sgem_hmhcia_interest_maximum_payment,#sgem_hmhcia_down_payment_pay,#sgem_hmhcia_p_loan_turm,#sgem_hmhcia_home_insurance_payment,#sgem_hmhcia_hoa_dues').length > 0) {
    $('#sgem_hmhcia_annual_income,#sgem_hmhcia_monthly_debts,#sgem_hmhcia_income_down_payment,#sgem_hmhcia_rent_payment,#sgem_hmhcia_loan_term,#sgem_hmhcia_home_insurance,#sgem_hmhcia_ahomeowners_association_dues,#sgem_hmhcia_interest_maximum_payment,#sgem_hmhcia_down_payment_pay,#sgem_hmhcia_p_loan_turm,#sgem_hmhcia_home_insurance_payment,#sgem_hmhcia_hoa_dues').on('keyup', function() {
...
function sgemGenarateSlider(calby) {
    ...
    rangerOne.onchange = function() {
        ...
        var sliderOnePig = ( parseFloat(25) / parseFloat(rangerOne.value) ) * parseFloat(43); 
        // var sliderOnePig1 = (sliderOnePig * parseFloat(100)) * parseFloat(2);
