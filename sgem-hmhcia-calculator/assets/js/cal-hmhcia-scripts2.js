$(function () { 	
	$('input.inputnumber').keyup(function(event) {
	 ...
	 $("#sgem_hmhcia_ethereum, #sgem_hmhcia_annual_return, #sgem_hmhcia_current_allocation, #sgem_hmhcia_expected_mortgage, #sgem_hmhcia_ethereum, #sgem_hmhcia_future_allocation, #sgem_hmhcia_future_bitcoin, #sgem_hmhcia_future_ethereum, #sgem_hmhcia_other_crypto").on('input', function() {
...
function sgem_hmhcia_calculate2(e) {
  ...
  var intrest_rate_d_retirement = 5 / 100;
	...
	// Validations
    var isValid = true;
	$('#sgem_hmhcia_annual_return, #sgem_hmhcia_retirement_age, #sgem_hmhcia_ethereum, #sgem_hmhcia_rent_payment, #sgem_hmhcia_age').each(function () {
		if ($.trim($(this).val()) == '') {
			isValid = false;
			$(this).css({
