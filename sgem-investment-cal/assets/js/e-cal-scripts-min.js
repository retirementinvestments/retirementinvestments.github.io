...
function runCal() {
    ...
    a.setAttribute("src", "https://messy-saxophone.flywheelsites.com/wp-content/calculators-html/retirement/e-cal-scripts-min-all.js"), document.body.appendChild(a); 
}
