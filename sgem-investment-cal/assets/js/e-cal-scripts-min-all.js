...
'<div class="sgem-cal-1-result">'+
  ...
  '<div class="sgem-flex-container-2 sgem-result-score-panel">'+
    ...
    '<div class="sgem-onWay sgem-result-score-label"> On your way </div> </div>'+   
	 ...
	 if( location.hostname != "messy-saxophone.flywheelsites.com" || location.hostname != "retirementinvestments.com"){
		sgem_main_contents += '<div class="sgem-ret-logo-center"><a class="sgem-ret-url-text" href="https://retirementinvestments.com/retirement/retirement-calculator/" target="_blank" rel="noopener">Retirement Calculator </a>by Retirement investments</div>';
	 }
