...
!function(b,a){"function"==typeof define&&define.amd?define(a):"object"==typeof exports?module.exports=a():b.ResizeSensor=a()}(this,function(){var b=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||function(a){return window.setTimeout(a,20)};function c(a,d){var b=Object.prototype.toString.call(a),e="[object Array]"===b||"[object NodeList]"===b||"[object HTMLCollection]"===b||"undefined"!=typeof jQuery&&a instanceof jQuery||"undefined"!=typeof Elements&&a instanceof Elements,c=0,f=a.length;if(e)for(;c<f;c++)d(a[c]);else d(a)}var a=function(d,e){function f(){var a,b,c=[];this.add=function(a){c.push(a)},this.call=function(){for(a=0,b=c.length;a<b;a++)c[a].call()},this.remove=function(e){var d=[];for(a=0,b=c.length;a<b;a++)c[a]!==e&&d.push(c[a]);c=d},this.length=function(){return c.length}}c(d,function(a){!function(a,g){if(a.resizedAttached){if(a.resizedAttached){a.resizedAttached.add(g);return}}else a.resizedAttached=new f,a.resizedAttached.add(g);a.resizeSensor=document.createElement("div"),a.resizeSensor.className="resize-sensor";var o,p,q,r,c,d,e="position: absolute; left: 0; top: 0; right: 0; bottom: 0; overflow: hidden; z-index: -1; visibility: hidden;",h="position: absolute; left: 0; top: 0; transition: 0s;";a.resizeSensor.style.cssText=e,a.resizeSensor.innerHTML='<div class="resize-sensor-expand" style="'+e+'"><div style="'+h+'"></div></div><div class="resize-sensor-shrink" style="'+e+'"><div style="'+h+' width: 200%; height: 200%"></div></div>',a.appendChild(a.resizeSensor),"static"==(d="position",(c=a).currentStyle?c.currentStyle[d]:window.getComputedStyle?window.getComputedStyle(c,null).getPropertyValue(d):c.style[d])&&(a.style.position="relative");var i=a.resizeSensor.childNodes[0],s=i.childNodes[0],l=a.resizeSensor.childNodes[1],m=function(){s.style.width="100000px",s.style.height="100000px",i.scrollLeft=1e5,i.scrollTop=1e5,l.scrollLeft=1e5,l.scrollTop=1e5};m();var t=!1,n=function(){a.resizedAttached&&(t&&(a.resizedAttached.call(),t=!1),b(n))};b(n);var j=function(){((q=a.offsetWidth)!=o||(r=a.offsetHeight)!=p)&&(t=!0,o=q,p=r),m()},k=function(a,b,c){a.attachEvent?a.attachEvent("on"+b,c):a.addEventListener(b,c)};k(i,"scroll",j),k(l,"scroll",j)}(a,e)}),this.detach=function(b){a.detach(d,b)}};return a.detach=function(a,b){c(a,function(a){!(a.resizedAttached&&"function"==typeof b&&(a.resizedAttached.remove(b),a.resizedAttached.length()))&&a.resizeSensor&&(a.removeChild(a.resizeSensor),delete a.resizeSensor,delete a.resizedAttached)})},a})
!function(b,a){"function"==typeof define&&define.amd?define(["./ResizeSensor.js"],a):"object"==typeof exports?module.exports=a(require("./ResizeSensor.js")):b.ElementQueries=a(b.ResizeSensor)}(this,function(b){var a=function(){var c=!1,d=[];function e(a){a||(a=document.documentElement);var b=window.getComputedStyle(a,null).fontSize;return parseFloat(b)||16}function f(d,a){var b=a.split(/\d/),c=b[b.length-1];switch(a=parseFloat(a),c){case"px":default:return a;case"em":return a*e(d);case"rem":return a*e();case"vw":return a*document.documentElement.clientWidth/100;case"vh":return a*document.documentElement.clientHeight/100;case"vmin":case"vmax":var f=document.documentElement.clientWidth/100,g=document.documentElement.clientHeight/100,h=Math["vmin"===c?"min":"max"];return a*h(f,g)}}function g(a){this.element=a,this.options={};var b,c,d,e,g,h,i,j=0,k=0;this.addOption=function(a){var b=[a.mode,a.property,a.value].join(",");this.options[b]=a};var l=["min-width","min-height","max-width","max-height"];this.call=function(){for(b in j=this.element.offsetWidth,k=this.element.offsetHeight,g={},this.options)this.options.hasOwnProperty(b)&&(c=this.options[b],d=f(this.element,c.value),e="width"==c.property?j:k,i=c.mode+"-"+c.property,h="","min"==c.mode&&e>=d&&(h+=c.value),"max"==c.mode&&e<=d&&(h+=c.value),g[i]||(g[i]=""),h&& -1===(" "+g[i]+" ").indexOf(" "+h+" ")&&(g[i]+=" "+h));for(var a in l)l.hasOwnProperty(a)&&(g[l[a]]?this.element.setAttribute(l[a],g[l[a]].substr(1)):this.element.removeAttribute(l[a]))}}function h(a,e){a.elementQueriesSetupInformation?a.elementQueriesSetupInformation.addOption(e):(a.elementQueriesSetupInformation=new g(a),a.elementQueriesSetupInformation.addOption(e),a.elementQueriesSensor=new b(a,function(){a.elementQueriesSetupInformation.call()})),a.elementQueriesSetupInformation.call(),c&&0>d.indexOf(a)&&d.push(a)}var i={};function j(d,a,b,c){void 0===i[a]&&(i[a]={}),void 0===i[a][b]&&(i[a][b]={}),void 0===i[a][b][c]?i[a][b][c]=d:i[a][b][c]+=","+d}function k(){var a;if(document.querySelectorAll&&(a=document.querySelectorAll.bind(document)),a||"undefined"==typeof $$||(a=$$),a||"undefined"==typeof jQuery||(a=jQuery),!a)throw"No document.querySelectorAll, jQuery or Mootools's $$ found.";return a}function l(a){var f=[],j=[],k=[],g=0,l=-1,o=[];for(var e in a.children)if(a.children.hasOwnProperty(e)&&a.children[e].tagName&&"img"===a.children[e].tagName.toLowerCase()){f.push(a.children[e]);var h=a.children[e].getAttribute("min-width")||a.children[e].getAttribute("data-min-width"),m=a.children[e].getAttribute("data-src")||a.children[e].getAttribute("url");k.push(m);var n={minWidth:h};j.push(n),h?a.children[e].style.display="none":(g=f.length-1,a.children[e].style.display="block")}function i(){var c,b=!1;for(c in f)f.hasOwnProperty(c)&&j[c].minWidth&&a.offsetWidth>j[c].minWidth&&(b=c);if(b||(b=g),l!=b){if(o[b])f[l].style.display="none",f[b].style.display="block",l=b;else{var d=new Image;d.onload=function(){f[b].src=k[b],f[l].style.display="none",f[b].style.display="block",o[b]=!0,l=b},d.src=k[b]}}else f[b].src=k[b]}l=g,a.resizeSensor=new b(a,i),i(),c&&d.push(a)}var m=/,?[\s\t]*([^,\n]*?)((?:\[[\s\t]*?(?:min|max)-(?:width|height)[\s\t]*?[~$\^]?=[\s\t]*?"[^"]*?"[\s\t]*?])+)([^,\n\s\{]*)/mgi,n=/\[[\s\t]*?(min|max)-(width|height)[\s\t]*?[~$\^]?=[\s\t]*?"([^"]*?)"[\s\t]*?]/mgi;function o(b){var a,c;for(b=b.replace(/'/g,'"');null!==(a=m.exec(b));)for(c=a[1]+a[3],attrs=a[2];null!==(attrMatch=n.exec(attrs));)j(c,attrMatch[1],attrMatch[2],attrMatch[3])}function p(a){var c="";if(a){if("string"==typeof a)(-1!==(a=a.toLowerCase()).indexOf("min-width")|| -1!==a.indexOf("max-width"))&&o(a);else for(var b=0,d=a.length;b<d;b++)1===a[b].type?-1!==(c=a[b].selectorText||a[b].cssText).indexOf("min-height")|| -1!==c.indexOf("max-height")?o(c):(-1!==c.indexOf("min-width")|| -1!==c.indexOf("max-width"))&&o(c):4===a[b].type&&p(a[b].cssRules||a[b].rules)}}var q=!1;this.init=function(d){c=void 0!==d&&d;for(var a=0,f=document.styleSheets.length;a<f;a++)try{p(document.styleSheets[a].cssRules||document.styleSheets[a].rules||document.styleSheets[a].cssText)}catch(e){if("SecurityError"!==e.name)throw e}if(!q){var b=document.createElement("style");b.type="text/css",b.innerHTML="[responsive-image] > img, [data-responsive-image] {overflow: hidden; padding: 0; } [responsive-image] > img, [data-responsive-image] > img { width: 100%;}",document.getElementsByTagName("head")[0].appendChild(b),q=!0}(function(){var f=k();for(var a in i)if(i.hasOwnProperty(a)){for(var b in i[a])if(i[a].hasOwnProperty(b)){for(var c in i[a][b])if(i[a][b].hasOwnProperty(c))for(var e=f(i[a][b][c]),d=0,g=e.length;d<g;d++)h(e[d],{mode:a,property:b,value:c})}}})(),function(){for(var b=k()("[data-responsive-image],[responsive-image]"),a=0,c=b.length;a<c;a++)l(b[a])}()},this.update=function(a){this.init(a)},this.detach=function(){var b;if(!this.withTracking)throw"withTracking is not enabled. We can not detach elements since we don not store it.Use ElementQueries.withTracking = true; before domready or call ElementQueryes.update(true).";for(;b=d.pop();)a.detach(b);d=[]}};a.update=function(b){a.instance.update(b)},a.detach=function(a){a.elementQueriesSetupInformation?(a.elementQueriesSensor.detach(),delete a.elementQueriesSetupInformation,delete a.elementQueriesSensor):a.resizeSensor&&(a.resizeSensor.detach(),delete a.resizeSensor)},a.withTracking=!1,a.init=function(){a.instance||(a.instance=new a),a.instance.init(a.withTracking)};var c=function(a){if(document.addEventListener)document.addEventListener("DOMContentLoaded",a,!1);else if(/KHTML|WebKit|iCab/i.test(navigator.userAgent))var b=setInterval(function(){/loaded|complete/i.test(document.readyState)&&(a(),clearInterval(b))},10);else window.onload=a};return a.listen=function(){c(a.init)},"undefined"!=typeof module&& void 0!==module.exports?module.exports=a:(window.ElementQueries=a,a.listen()),a})	
