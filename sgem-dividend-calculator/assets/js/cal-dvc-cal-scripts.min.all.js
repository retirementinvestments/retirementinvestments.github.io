                ...
                '<div class="sgem-dvc-block-container">'+
                    ...
                    '<div class="sgem-dvc-block-inner-container">'+
                        ...
                        '<div class="sgem-dvc-form-group sgem-dvc-form-flex sgem-dvc-interest-precentage-holder sgem-second-flex">'+
                            ...
                            '<input type="text" class="inputmove inputnumber" id="sgem_dvc_annual_dividend_yield" value="3" min="0" max="100000"/>'+
                    ...
                    '<div class="sgem-dvc-block-inner-container">'+
                        ...
                        '<div class="sgem-dvc-form-group sgem-dvc-form-flex sgem-dvc-interest-precentage-holder sgem-second-flex">'+
                            ...
                            '<input type="text" class="inputmove inputnumber" id="sgem_dvc_dividend_tax_rate" value="15" min="0" max="100000" />'+
                    ...
                    '<div class="sgem-dvc-block-inner-container">'+
                        '<div class="sgem-dvc-form-group sgem-sp-flex-active sgem-dvc-form-flex sgem-dvc-interest-precentage-holder  sgem-first-flex">'+
                            ...
                            '<input type="text" class="inputmove inputnumber" id="sgem_dvc_exp_dividend_payout_rise" value="10" min="0" max="100000"/>'+
                        ...
                        '<div class="sgem-dvc-form-group sgem-sp-flex-active sgem-dvc-form-flex sgem-dvc-interest-precentage-holder sgem-second-flex">'+
                            ...
                            '<input type="text" class="inputmove inputnumber" id="sgem_dvc_ext_stock_price_rise" value="10" min="0" max="100000"/>'+
            ...
            '<div class="sgem-dvc-cal-1-result-wrapper">'+
                ...
                '<div class="sgem-dvc-cal-1-result-footer">'+
                    ...
                    '<div class="sgem-dvc-section-table-result">'+
                        ...
                        '</details>'+
                    '</div>'+
					'<div class="sgem-dvc-button-narration">Start investing in dividend stocks commission-free on our recommended investment app.</div>'+                   
...
if(location.hostname == "calculatorstg.wpengine.com" || location.hostname == "retirementinvestments.com" || location.hostname == "staging.retirementinvestments.com"){
    sgem_dvc_main_contents += '<div class="sgem-dvc-copy-option-panel">';
    sgem_dvc_main_contents += '<h3>Do you want to add this calculator into your website?</h3>';
    sgem_dvc_main_contents += '<div class="sgem-dvc-copy-code-wrap">';
    sgem_dvc_main_contents += '<button class="sgem-dvc-copy-code" id="sgem-dvc-copy-code" onclick="sgem_dvc_copyText(event)">Get Calculator</button>';
    sgem_dvc_main_contents += '</div></div></div>';
}

sgem_dvc_main_contents += '</div>';  

document.getElementById('sgem-dvc-cal').innerHTML = sgem_dvc_main_contents;
...
function addRow(bodyHTML, tableDividendRowData) {
    var rowHTML = '<tr><td scope="row" data-label="Year" style="width:10.2%;">' + tableDividendRowData[0] + '</td><td data-label="Shared owned initially" style="width:16.1%;">' + numberWithCommas(parseFloat(tableDividendRowData[1]).toFixed(2)) + '</td><td data-label="Starting stock price" style="width:18.1%;">$' + numberWithCommas(parseFloat(tableDividendRowData[2]).toFixed(2)) + '</td><td data-label="Annual contribution" style="width:18.1%;">$' + numberWithCommas(parseFloat(tableDividendRowData[3]).toFixed(2)) + '</td><td data-label="Year end dividend after tax" style="width:20.1%;">$' + numberWithCommas(parseFloat(tableDividendRowData[4]).toFixed(2)) + '</td><td data-label="Final balance after tax" style="width:17.4%;">$' + numberWithCommas(parseFloat(tableDividendRowData[5]).toFixed(2)) + '</td></tr>';
...
localStorage.setItem('sgem-dvc-cal-copy', '<div id="sgem-dvc-cal"></div><script>window.onload = function() {var sgdvccal = document.createElement("script");sgdvccal.type = "text/javascript";sgdvccal.src = "https://retirementinvestments.github.io/sgem-dividend-calculator/assets/js/cal-dvc-cal-scripts.min.js";document.body.appendChild(sgdvccal);} </script>'); 

function sgem_dvc_copyText(ev){
  //console.log("hi");
  let div = document.getElementById('div');
  let text = localStorage.getItem('sgem-dvc-cal-copy');
